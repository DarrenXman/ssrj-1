...
- (void)loadLaunchImage2:(NSString *)imageName iconName:(NSString *)icon{
	...
	// 3. icon
    _iconImage = nil;//[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"logo_coding_top"]];
	//_iconImage.frame = CGRectMake((SCREEN_WIDTH - 213) * 0.5, 80, 213, 54);
	
    //_iconImage.frame = CGRectMake((SCREEN_WIDTH - 213) * 0.5, 80, 213, 54);
    _iconImage.frame = CGRectMake(0, SCREEN_HEIGHT * 0.5, SCREEN_WIDTH, 50);
...
- (void)loadLaunchImage:(NSString *)imgName
	...
	if (iconName.length != 0) {
        ...
        //self.iconImage.frame = CGRectMake((SCREEN_WIDTH - 213) * 0.5, 80, 213, 54);
        self.iconImage.frame = CGRectMake(0, SCREEN_HEIGHT * 0.245, SCREEN_WIDTH, SCREEN_HEIGHT * 0.175);
